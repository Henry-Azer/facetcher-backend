...
(
    ...
    image_properties   CHARACTER VARYING(250) NOT NULL,
    gender             CHARACTER VARYING(50)  NOT NULL,
    title              CHARACTER VARYING(250) NOT NULL,
    description        TEXT                   NOT NULL,
    exception_occurred BOOLEAN                NOT NULL,
    ...
    CONSTRAINT user_trial_user_submission_id_fk FOREIGN KEY (user_submission_id) REFERENCES public.user_submission (id),
